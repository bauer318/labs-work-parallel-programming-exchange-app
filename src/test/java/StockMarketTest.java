...
public class StockMarketTest {
    ...
    public void addOrderTest() {
        ...
        Order order = new Order(client, CurrencyPairs.USD_TO_RUB, OrderType.BUY, new BigDecimal(15), new BigDecimal(66.66));
    ...
    public void addTwoMatchingOrdersWithDepositRevokedTest() {
        ...
        Order order2 = new Order(client2, CurrencyPairs.USD_TO_RUB, OrderType.BUY, new BigDecimal(15), new BigDecimal(66.66));
        stockMarket.addOrder(order2);
    ...
    public void addOrderMatchingTwoAndClosingOneTest() {
        ...
        Client client3 = new Client(3);
        client3.deposit(Currency.RUB, new BigDecimal(10_000));
        Order order3 = new Order(client3, CurrencyPairs.USD_TO_RUB, OrderType.BUY, new BigDecimal(25), new BigDecimal(80));
        stockMarket.addOrder(order3);
    ...
    public void addTwoOrdersNotMatchingByPriceTest() {
        ...
        Order order2 = new Order(client2, CurrencyPairs.USD_TO_RUB, OrderType.BUY, new BigDecimal(25), new BigDecimal(60));
        stockMarket.addOrder(order2);
